...
<head>
    ...
    <link rel="stylesheet" href="../../Angeles/styles/register_student.css" type="text/css" />
...
<body>
    ...
    <div class="container mt-3 text-center">
        <div class="row justify-content-center">
            ...
            <div class="register-student-form col">
                ...
                <form method="post" action="../../Angeles/tasks/do_register.php">
                    <div class="row">
                        <div class="col mb-2">
    ...
    <script src="../../Angeles/js/register.js" type="text/javascript"></script>
</body>
